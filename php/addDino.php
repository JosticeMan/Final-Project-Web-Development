...
<html>
	...
	<body onload = "initialize();">
		...
		<div class = "information">
			<marquee style = "color: #00b3b3;" DIRECTION=LEFT > Please complete the form to add a dinosaur, <?php $survivor = $_GET["Survivor"]; echo "".$survivor; ?>! </marquee>	
		</div>
		...
		<form method = "POST" action = "processDino.php?Survivor=<?php echo $survivor ?>" style = "position: relative; top: 70px; color: #006666;">
			<span class = "information"> Add a dinosaur </span> <br />
			...
			<input type = "submit" value = "Add Dinosaur!" style = "border-radius: 5px; color: #006666;" />
		</form>
